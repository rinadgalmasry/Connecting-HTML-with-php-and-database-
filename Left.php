...
$mydistance = $_REQUEST['mydistanceL'];
echo "The robot is moving Left a distance of : ".$mydistance;
echo "<br>";
...
// insert record Left
$sql = "INSERT INTO `robot moves` (moves,distance) Values ('Left',".$mydistance.")";
//Print_r($sql);
