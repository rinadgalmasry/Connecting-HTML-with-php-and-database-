...
$mydistance = $_REQUEST['mydistanceR'];
echo "The robot is moving Right a distance of : ".$mydistance;
echo "<br>";
...
// insert record Right
$sql = "INSERT INTO `robot moves` (moves,distance) Values ('Right',".$mydistance.")";
//Print_r($sql);
