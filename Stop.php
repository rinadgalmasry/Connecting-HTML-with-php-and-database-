...
$mydistance = $_REQUEST['mydistanceS'];
echo "The robot is moving Stop a distance of : ".$mydistance;
echo "<br>";
...
// insert record Stop
$sql = "INSERT INTO `robot moves` (moves,distance) Values ('Stop',".$mydistance.")";
//Print_r($sql);
