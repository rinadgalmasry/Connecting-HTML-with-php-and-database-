...
$mydistance = $_REQUEST['mydistanceB'];
echo "The robot is moving backwards a distance of : ".$mydistance;
echo "<br>";
...
// insert record backwords
$sql = "INSERT INTO `robot moves` (moves,distance) Values ('backwords',".$mydistance.")";
//Print_r($sql);
